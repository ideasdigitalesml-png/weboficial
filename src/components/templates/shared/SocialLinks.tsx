...
export function SocialLinks({
  ...
  return (
    ...
    >
      {hasLinkedin && (
        <a href={linkedinUrl} target="_blank" rel="noopener" aria-label="LinkedIn" style={{ display: "inline-flex", color: "inherit" }}>
      ...
      {hasInstagram && (
        <a href={instagramUrl} target="_blank" rel="noopener" aria-label="Instagram" style={{ display: "inline-flex", color: "inherit" }}>
