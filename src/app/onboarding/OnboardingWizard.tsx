...
// Generated by `npm run generate:previews` (scripts/generate-previews.js),
// which fills each template's {{placeholders}} with fictional sample data,
// renders it with Playwright, and writes a JPEG (public/previews/) shown as
// the full card image below. Templates without an entry here (e.g.
// contador/clasico, contador/minimal -- never ported, still rendered by the
// generic legacy template) fall back to a plain name-only card.
