...
export const PRIMARY_BUTTON =
  "inline-flex min-h-[52px] items-center justify-center rounded-full bg-sky px-6 text-base font-semibold text-white transition-colors hover:bg-sky-dark disabled:opacity-40";
export const SECONDARY_BUTTON =
  "inline-flex min-h-[52px] items-center justify-center rounded-full border border-border-subtle px-6 text-base font-medium text-navy transition-colors hover:border-navy/40";
